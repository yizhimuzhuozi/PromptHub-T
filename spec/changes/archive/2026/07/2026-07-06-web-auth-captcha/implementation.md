...
- `pnpm --filter @prompthub/web lint`
  - 结果：通过
- `git diff --check -- apps/web/src/client/contexts/AuthContext.tsx apps/web/src/client/contexts/AuthContext.test.tsx spec/changes/archive/2026/07/2026-07-06-web-auth-captcha spec/issues/active/quality.md`
  - 结果：通过
