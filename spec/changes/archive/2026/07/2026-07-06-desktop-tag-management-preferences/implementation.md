...
- `git diff --check -- apps/desktop/src/renderer/stores/settings.store.ts apps/desktop/tests/unit/stores/settings-tags.test.ts spec/changes/archive/2026/07/2026-07-06-desktop-tag-management-preferences spec/issues/active/quality.md`
