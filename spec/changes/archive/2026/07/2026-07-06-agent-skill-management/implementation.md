...
- `pnpm --filter @prompthub/desktop lint`
  - Result: passed.
- `git diff --check -- apps/desktop/src/renderer/stores/settings.store.ts apps/desktop/src/renderer/services/agent-root-paths.ts apps/desktop/tests/unit/stores/settings-agent-roots.test.ts spec/changes/archive/2026/07/2026-07-06-agent-skill-management spec/issues/active/quality.md`
  - Result: passed.
