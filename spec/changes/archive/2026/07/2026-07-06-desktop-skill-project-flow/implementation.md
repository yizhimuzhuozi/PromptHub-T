...
- `pnpm --filter @prompthub/desktop lint`
  - 结果：通过
- `git diff --check -- apps/desktop/src/renderer/stores/settings.store.ts apps/desktop/tests/unit/stores/settings-agent-roots.test.ts spec/changes/archive/2026/07/2026-07-06-desktop-skill-project-flow spec/issues/active/quality.md`
  - 结果：通过
