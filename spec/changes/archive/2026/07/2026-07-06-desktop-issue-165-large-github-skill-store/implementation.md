...
- `git diff --check -- apps/desktop/src/main/services/skill-installer-remote.ts apps/desktop/tests/unit/main/skill-installer-remote.test.ts spec/changes/archive/2026/07/2026-07-06-desktop-issue-165-large-github-skill-store` passed.
