...
- `git diff --check -- apps/desktop/src/renderer/components/layout/Sidebar.tsx apps/desktop/tests/unit/components/sidebar.test.tsx spec/changes/archive/2026/07/2026-07-06-desktop-issue-166-skill-store-scroll` passed.
