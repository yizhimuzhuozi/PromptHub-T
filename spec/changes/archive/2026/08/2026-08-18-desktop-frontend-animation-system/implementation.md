...
Status: completed. The only unchecked item is a PR-only GIF/video attachment;
no PR operation is authorized or pending in the local delivery lifecycle, so it
does not keep this implementation active.
