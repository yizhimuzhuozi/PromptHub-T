...
- `spec/knowledge/behavior/desktop.md` 已同步一级模块、顺序/显隐恢复和侧栏收起行为。

## Lifecycle Disposition (2026-08-18)

Status: completed. Implementation, verification, and stable Desktop behavior
are synchronized; later unrelated i18n cleanup remains outside this change.
