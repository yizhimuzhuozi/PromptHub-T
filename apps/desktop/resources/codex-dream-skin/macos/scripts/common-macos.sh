...
STATE_ROOT="${PROMPTHUB_DREAM_SKIN_STATE_ROOT:-$HOME/Library/Application Support/PromptHub/CodexDreamSkinRuntime}"
...
CODEX_APP_JOB_LABEL="com.prompthub.codex-dream-skin.app"
INJECTOR_JOB_LABEL="com.prompthub.codex-dream-skin.injector"
